 ...
 */
final class Version20220226141216 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE Telefone (id INTEGER NOT NULL, aluno_id INTEGER DEFAULT NULL, telefone VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
